...
// PROPS = = react is a component bases lib , divides the ui into little reusable piences . in some cases those components need to communicate and the way to pass data b/w com is by using props

//  props is a special keyword in react whivvh stands for porperties and is being used for passing data from one component to another . data with props are being passed in a uni directional flow (parent to child)
// props data is read only , which means that data coming from the paret should not be changed by child components 


// class parentComp extends component {
// render(){
// return ( 
// <hi> im he first child 
// <ChildComponent/>
// </hi>)
// };
// }
...
//                 <ChildComponent text =  "the first ChildComponent"/>
                   /* <ChildComponent text = "im the sec ChildComponent"/>
                   <ChildComponent text = "im the third ChildComponent"/>  */
//             </h1>
//         )
//     }
// }
